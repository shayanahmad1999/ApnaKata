      ...
      <section class="content-header">
        ...
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1 class="m-0">University Kata</h1>
              </div><!-- /.col -->
              <div class="col-sm-6">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-6">
                      ...
                      <h4 class="card-title">
                        ...
                        if (isset($_GET['table_search'])) {
                          ...
                          $query = "SELECT *,(paymentBRT + paymentLocal) as Total FROM `tblpaymentuni` WHERE paymentDate like '%$search%'";
                          $responce = mysqli_query($connect, $query);
                          if ($responce) {
                            $query = "SELECT *,SUM(paymentBRT) as totalBRT,SUM(paymentLocal) as totalLocal,SUM(paymentBRT + paymentLocal) as Total FROM `tblpaymentuni` WHERE paymentDate like '%$search%'";
                          ...
                          $query = "SELECT *,(paymentBRT + paymentLocal) as Total FROM `tblpaymentuni`";
                          $responce = mysqli_query($connect, $query);
                        }
                    ...
                    <table id="table-id" class="table table-hover text-nowrap">
                      ...
                      <tbody>
                        ...
                        ?>
                          <tr>
                            <td><?php echo $a; ?></td>
                            <td><?php echo $result['paymentBRT']; ?></td>
                            <td><?php echo $result['paymentLocal']; ?></td>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <!-- ::::::::::::::::: Form Start ::::::::::::::::::::::: -->
            <form class="form-horizontal" action="process/kataInsertionUni.php" method="post">
              <div class="card-body">
                <div class="row">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <table class=" table table-responsive p-0  table-hover text-nowrap">
              ...
              <tbody>
                <?php
                $query = "SELECT *,SUM(paymentBRT) as totalBRT,SUM(paymentLocal) as totalLocal,SUM(paymentBRT + paymentLocal) as Total FROM `tblpaymentuni`";
                $responce = mysqli_query($connect, $query);
