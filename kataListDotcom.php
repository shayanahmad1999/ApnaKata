                    ...
                    <div class="col-sm-6 col-md-6 col-lg-6">
                      ...
                      <h4 class="card-title">
                        ...
                        if (isset($_GET['table_search'])) {
                          ...
                          $query = "SELECT *,(paymentBRTDotCom + paymentLocalDotCom) as Total FROM `tblpaymentdotcom` WHERE paymentDateDotCom like '%$search%'";
                          $responce = mysqli_query($connect, $query);
                          if ($responce) {
                            $query = "SELECT *,SUM(paymentBRTDotCom) as totalBRT,SUM(paymentLocalDotCom) as totalLocal,SUM(paymentBRTDotCom + paymentLocalDotCom) as Total FROM `tblpaymentdotcom` WHERE paymentDateDotCom like '%$search%'";
                          ...
                          $query = "SELECT *,(paymentBRTDotCom + paymentLocalDotCom) as Total FROM `tblpaymentdotcom`";
                          $responce = mysqli_query($connect, $query);
                        }
                    ...
                    <table id="table-id" class="table table-hover text-nowrap">
                      ...
                      <tbody>
                        ...
                        ?>
                          <tr>
                            <td><?php echo $a; ?></td>
                            <td><?php echo $result['paymentBRTDotCom']; ?></td>
                            <td><?php echo $result['paymentLocalDotCom']; ?></td>
                            <td><?php echo $result['paymentDateDotCom']; ?></td>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <!-- ::::::::::::::::: Form Start ::::::::::::::::::::::: -->
            <form class="form-horizontal" action="process/kataInsertionDotCom.php" method="post">
              <div class="card-body">
                <div class="row">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <table class=" table table-responsive p-0  table-hover text-nowrap">
              ...
              <tbody>
                <?php
                $query = "SELECT *,SUM(paymentBRTDotCom) as totalBRT,SUM(paymentLocalDotCom) as totalLocal,SUM(paymentBRTDotCom + paymentLocalDotCom) as Total FROM `tblpaymentdotcom`";
                $responce = mysqli_query($connect, $query);
